...
export const Settings = () => html` <style>
  ...
  <portal-navigation src="./data/data-settings.json" logoutMenuInMetaBar internalRouting mobileBreakpoint="1200" currentApplication="ebanking" @portal-navigation.configured="${dispatchBadgeEvents}" class="settings">
    <span slot="logo" style="font-size: 0.75rem; display: flex; align-items: center;">Logo slot</span>
