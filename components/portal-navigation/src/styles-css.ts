...
.tree-container > .link {
  padding: var(--portal-navigation-tree-parent-padding-y, var(--portal-navigation-menu-item-padding-y, 0.5rem)) var(--portal-navigation-tree-parent-padding-x, var(--portal-navigation-horizontal-base, 1rem));
}
...
.tree-items > .link {
  ...
  padding: var(--portal-navigation-tree-items-link-padding-y, var(--portal-navigation-menu-item-padding-y, 0.5rem)) var(--portal-navigation-tree-items-link-padding-x, var(--portal-navigation-horizontal-base, 1rem));
}
...
.container.-mobile .navigation-header {
  padding: var(--portal-navigation-header-vertical-padding, var(--portal-navigation-vertical-base, 0.5rem)) var(--portal-navigation-header-horizontal-padding, 0);
}
`;